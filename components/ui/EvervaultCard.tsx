    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative rounded-full flex items-center justify-center text-white font-bold text-5xl">
            <div className="absolute w-full h-full blur-sm rounded-full" />
            <span className="dark:text-white text-black z-20 relative"><span className="text-shadow text-shadow-orange-500 text-shadow-x-1 text-shadow-y-1 text-shadow-blur-9">My</span> <span className={`${nyght} text-shadow text-shadow-orange-500 text-shadow-x-1 text-shadow-y-1 text-shadow-blur-9`}>Education</span></span>
            <span className="w-[38rem] mt-16 via- absolute">
        {/* Gradients */}
